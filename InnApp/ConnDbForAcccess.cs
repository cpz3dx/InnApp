...
namespace InnApp
{
    class ConnDbForAcccess
    {
        ...
        public ConnDbForAcccess()
        {
            ...
            connectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=F:\MyLab\InnApp\InnApp\inndata.mdb";
        ...
        {
            connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" +  newConnectionString;
            Connection = new OleDbConnection(connectionString);
        }
